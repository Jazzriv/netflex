...
<html>
	...
	<body>
		<header>
			<img src="img/logo.png" alt="Logo Netlfex" id="logo" />
		</header>
		...
		<div id="main-container">
			...
			<div id="content">
				...
				<div class="panel" id="connection">
					<h2>Se connecter</h2>
					<form id="conform" method="POST" action="test.php">
		...
		<!-- SCRIPTS -->
		<!-- popup script --><script type="text/javascript" src="js/popup.js"></script>
